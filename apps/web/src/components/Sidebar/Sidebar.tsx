  ...
  return (
    <nav className="sidebar">
      <div className="sticky">
        <h3 className="mb-5 text-3xl font-bold dark:text-white">Ici Logo</h3>
        <ul className="nav flex flex-col justify-center pt-4">
          <li className="mb-4 flex items-center">
            ...
            <a aria-current="page" className="nav-link ml-2" href={ROUTER_PATH.HOME}>
              Home
            </a>
          </li>
          <li className="mb-4 flex stroke-white">
            ...
            <a aria-current="page" className="nav-link ml-2" href={ROUTER_PATH.PROFIL}>
              Profil
            </a>
          </li>
          <li className="mb-4 flex stroke-white">
            ...
            <a aria-current="page" className="nav-link ml-2" href={ROUTER_PATH.USERS}>
              Users
            </a>
          </li>
        </ul>
